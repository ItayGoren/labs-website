...
class Page extends React.Component {
    ...
    render() {
        return <div>
            <PageHeader labTestName={this.state.lab_test_name} labTestId={this.state.lab_test_id} labTestPanel={this.state.lab_test_panel} supportedPanels={this.state.supported_panels}/>
